...
[<img src="https://github-ads.s3.eu-central-1.amazonaws.com/laravel-route-maze.jpg?t=1" width="419px" />](https://spatie.be/github-ad-click/laravel-route-maze)
...
```bash
php artisan vendor:publish --tag="laravel-route-maze-migrations"
php artisan migrate
```
...
```bash
php artisan vendor:publish --tag="laravel-route-maze-views"
```

## Usage

```php
$routeMaze = new Ricventu\RouteMaze();
echo $routeMaze->echoPhrase('Hello, Ricventu!');
```
